    ...
    <div :class="[
        ...
        <div v-if="isCompact" class="flex items-center justify-between">
            ...
            <div class="ml-4 flex items-center space-x-2">
                <div class="h-8 w-8 bg-gray-100 rounded-full animate-pulse"></div>
                <div class="h-8 w-8 bg-gray-100 rounded-full animate-pulse"></div>
            </div>
        </div>
        ...
        <div v-else>
            <div class="mb-4">
                <div class="h-8 w-24 bg-gray-200 rounded mb-3 animate-pulse"></div>
                <div class="flex gap-2 mb-3">
                    <div class="h-6 w-16 bg-gray-100 rounded animate-pulse"></div>
                    <div class="h-6 w-14 bg-gray-100 rounded animate-pulse"></div>
                </div>
            </div>

            <div class="mb-6">
                <div class="h-4 w-20 bg-gray-200 rounded mb-2 animate-pulse"></div>
                <div class="space-y-1">
            ...
            <div class="flex items-center justify-between pt-4 border-t">
                <div class="flex gap-2">
                    <div class="h-6 w-12 bg-gray-100 rounded-full animate-pulse"></div>
                    <div class="h-6 w-10 bg-gray-100 rounded-full animate-pulse"></div>
                </div>
