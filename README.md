...
...это небольшое веб-приложение для ведения личного японского словаря. В нём вы можете создавать, читать, обновлять и удалять слова, а также организовывать слова по темам (тегам) и даже... управлять личным кабинетом и настраивать свою аватарку!😜
...
### Быстрый старт через [Makefile](./Makefile "Makefile")
...
В ветке [gh-pages](https://github.com/MindlessMuse666/j-dict/tree/gh-pages "Ветка со статической версией фронтенда") находится статическая версия фронтенда, которая используется для демо UI проекта на GitHub Pages.
